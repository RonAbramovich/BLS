...
HashToPoint(message, curve):
    Step 1: x₀ = MessageToInteger(message, p)
    Step 2: P_temp = IncrementAndTry(x₀, curve)
...
- Initial: x₀ = 0
- Process byte 65: x₀ = (0 × 256 + 65) mod 101 = 65
- Process byte 66: x₀ = (65 × 256 + 66) mod 101 = 16706 mod 101 = 40
- Result: x₀ = 40
...
Find a valid point on the curve starting from x-coordinate x₀.

### 4.2 Algorithm

```
IncrementAndTry(x₀, curve):
...
Curve: y^2 = x^3 + 2 over F_7 (note: 7 ≡ 3 mod 4 ✓)
Starting: x₀ = 1
...
- Since |E| × P_temp has order dividing |E|, and we multiply by h = |E|/r
- The result h × P_temp has order dividing r
...
Verification: 3 × H(m) should be O
...
- x₀ = 0
- x₀ = (0 × 256 + 104) mod 7 = 104 mod 7 = 6
- x₀ = (6 × 256 + 101) mod 7 = 1637 mod 7 = 6
- ... (continuing for all bytes)
- Result: x₀ = some value in [0, 6]

**Step 2 - Find Point**:
- Try x = x₀, x₀+1, x₀+2, ... until valid point found
...
This construction is essential for BLS signatures, where the signature σ = a · H(m) requires hashing the message m to a curve point.
